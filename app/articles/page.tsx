...
import { articleContent } from "@/constants/index";

// Exportation de l'objet Metadata
export const metadata: Metadata = {
  title: articleContent.title, // Assigner la valeur de title
  description: articleContent.description, // Assigner la valeur de description
};
